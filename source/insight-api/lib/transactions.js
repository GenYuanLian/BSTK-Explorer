...
TxController.prototype.transformTransaction = function(transaction, options, callback) {
  ...
  var confirmations = this.node.services.bitcoind.confirmations;
  //if(transaction.height >= 0) {
  //  confirmations = 1;//this.node.services.bitcoind.height - transaction.height + 1;
  //}


  console.log("michael laoliu ===============================================");
  //console.log(transaction);
  console.log(transaction.height);
  console.log(this.node.services.bitcoind.heigh); //this.node.services.bitcoind.height abnormal
  //console.log(transaction.height);
  console.log("michael laoliu ===============================================");
  ...
  transformed.confirmations = confirmations;//this value abnormal michael laoliu

  console.log("michael laoliu -----------------------------------------------");
  console.log(transformed);
  console.log("michael laoliu ＋＋+＋+＋+＋+＋+＋+＋+＋+＋+＋+＋+＋+＋+＋+＋+＋+＋-");
  console.log(transformed.blockheight);
  console.log(transformed.confirmations);
  console.log("michael laoliu -----------------------------------------------");
...
TxController.prototype.transformInput = function(options, input, index) {
  ...
  //michael debug
  //transformed.isConfirmed = true; // TODO
  //transformed.confirmations = 9; // TODO
  //transformed.unconfirmedInput = 0; // TODO
